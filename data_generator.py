...
csv = "order_id,company_id,product_id,day_of_week,consecutive_order_count,reordered,order_number\n"
...
for company_id in orders_array_by_company_id:
    ...
    for order_number, order in enumerate(company_orders):
        ...
        for product_id in order:
            ...
            csv += f"{order_id},{company_id},{product_id},{day_of_week},{consecutive_order_count},{0 if consecutive_order_count > 1 else 1},{order_number + 1}\n"
